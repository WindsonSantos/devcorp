...
DEV_USERNAME="devrede"
STAGING_USERNAME="cicorp"
PROD_USERNAME="windsonsantos@wizsolucoes.com.br.enterprise"

# Repository with your code (e.g. wadewegner/GIFter)
GITHUB_REPO="https://github.com/WindsonSantos/devcorp.git"

# Your package name (e.g. GIFter)
PACKAGE_NAME="packagepipeline"
